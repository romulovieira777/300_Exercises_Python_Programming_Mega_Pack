...
Expected result:
    ...
    '2020-03-23', '2020-03-24', '2020-03-25', '2020-03-26', '2020-03-27', '2020-03-30', '2020-03-31'], 'Close': [310.0,
    340.5, 330.0, 315.0, 305.0, 258.0, 264.0, 245.0, 197.0, 211.0, 240.5, 264.0
"""
# Solution I
with open('..\Data\playway.csv', 'r') as file:
    content = file.read().splitlines()

content = [line.split(',') for line in content]
content = {line[0]: line[-2] for line in content[1:]}
content = {key: float(value) for key, value in content.items()}
content = {'Date': list(content.keys()), 'Close': list(content.values())}
